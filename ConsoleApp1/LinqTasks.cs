    ...
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task4()
        {
            IEnumerable<Emp> result =
                from emp in Emps where emp.Salary == (from e in Emps select e.Salary).Max() select emp;
            return result;
        }
        ...
        {
            bool result = (from emp in Emps where emp.Job == "Backend programmer" select emp).Any();
            return result;
        }
        ...
        {
            IEnumerable<object> result = (from emp in Emps select new { emp.Ename, emp.Job, emp.HireDate }).Union(new[]
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = from emp in Emps
                ...
                into dg
                where dg.Count() > 1
                select new { name = dg.Key.Dname, numOfEmployees = dg.Count() };
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = from emp in Emps
                join mgr in Emps on emp.Mgr equals mgr into managers
                where managers.Any()
        ...
        {
            int result = (from number in arr group number by number into gr where gr.Count() % 2 != 0 select gr.Key)
                .First();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = from dept in Depts
                join emp in Emps on dept.Deptno equals emp.Deptno into gr
        ...
        {
            IEnumerable<Object> result = from emp in Emps from dept in Depts select new { E = emp, D = dept };
            return result;
        }
    }
